...
const translations = {
  nl: {
    ...
    'live.d5': "de site van m'n compagnon",
    'live.d6': 'het team en de tooling achter ons klantwerk',
    'live.d7': 'ons klantportaal, achter een login',
    'live.d8': 'eigen budget-app',
    ...
    'index.jordi': "Sprekerssite van m'n compagnon, met voorgerenderde routes voor SEO.",
  ...
  en: {
    ...
    'live.d5': "my business partner's site",
    'live.d6': 'the team and tooling behind our client work',
    'live.d7': 'our client portal, behind a login',
    'live.d8': 'my own budgeting app',
    ...
    'index.jordi': "My business partner's speaker site, with prerendered routes for SEO.",
  ...
  uk: {
    ...
    'live.d5': 'сайт мого компаньйона',
    'live.d6': 'команда та інструменти за нашими проєктами',
    'live.d7': 'наш клієнтський портал, потрібен логін',
    'live.d8': 'власний бюджетний застосунок',
    ...
    'index.jordi': 'Сайт мого компаньйона як спікера, з пререндером для SEO.',
  ...
  ru: {
    ...
    'live.d5': 'сайт моего компаньона',
    'live.d6': 'команда и инструменты за нашими проектами',
    'live.d7': 'наш клиентский портал, нужен логин',
    'live.d8': 'собственное бюджетное приложение',
    ...
    'index.jordi': 'Сайт моего компаньона как спикера, с пререндером для SEO.',
